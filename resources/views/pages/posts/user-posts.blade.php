            ...
            <h5>
                @if ($userPosts->count() === 0)
                    <p class="text-muted text-center">
                        @foreach ($users as $user)
                            <h5><img src="{{ Storage::url($user->profile_image) }}" alt="Profile Image"
                    ...
                    <div class="col-12 col-lg-6 pb-5 p-0">
                        <div class="d-flex flex-column justify-content-center w-100 mx-auto" style="max-width: 680px">
                            ...
                            @if ($user)
                                @if ($userPosts->count() === 0)
                                    <p class="text-muted text-center">
                                        Ops! {{ $user->name }} has no posts yet
                                    </p>
                                @endif
                            @else
                                <p class="text-muted text-center fs-5 mt-5">
                                    <i class="fas fa-times text-danger"></i> Ops! Something went wrong on this page!
                                </p>
                            @endif
